...
// // const pictureTitle= document.querySelector(imageSelectors.pictureTitle);// не используется нигде
// // const pictureUrl = document.querySelector(imageSelectors.pictureUrl); // не используется нигде
// const btnCloseAddPhotoOverlay = document.querySelector(imageSelectors.closeAddPhotoOverlayBTN);
// const btnOpenPhoto = document.querySelector(imageSelectors.openPhotoBtn);//new не используется
...
// const photoUrl = document.querySelector(createCardSelectors.link); //не используется
